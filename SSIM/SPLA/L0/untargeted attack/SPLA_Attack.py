"""
The primary function of the current code file is to perform untargeted attacks on a specified convolutional neural network model using ASMP based on the L0 norm.
