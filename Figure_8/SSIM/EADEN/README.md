The current folder contains the source code files. This folder includes the EADEN white-box attack. There are two subfolders representing targeted and untargeted attacks, respectively.
 ## Step 1
