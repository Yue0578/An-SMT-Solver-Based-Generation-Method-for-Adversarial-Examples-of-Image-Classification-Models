"""
The primary function of the current code file is to perform targeted attacks on a specified convolutional neural network model using ASMP based on the infinite norm.
...
for file_name in file_list:
    ...
    atk = SPLA(model, eps=eps_inf, alpha=0.017, steps=max_num_iterative, mask=mask, targeted=True)
