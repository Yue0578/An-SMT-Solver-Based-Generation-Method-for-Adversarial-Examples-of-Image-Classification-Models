"""
The primary function of the current code file is to perform targeted attacks on a specified convolutional neural network model using SPLA based on the L0 norm.
