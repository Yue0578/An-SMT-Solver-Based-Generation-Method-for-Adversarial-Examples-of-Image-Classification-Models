"""
The primary function of the current code file is to perform untargeted attacks on a specified convolutional neural network model using ASMP based on the L2 norm.
...
for file_name in file_list:
    ...
    # Binary search for minimal lambda such that orig + lambda * delta is adversarial
    iterative_num = 1
    left = 0.0
    right = 1.0
